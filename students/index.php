...
<form method="get" class="filter-row card">
    ...
    <div class="field">
        ...
        <select id="active" name="active">
            <option value="active"   <?= $activeIn === 'active'   ? 'selected' : '' ?>>Active</option>
            <option value="inactive" <?= $activeIn === 'inactive' ? 'selected' : '' ?>>Inactive</option>
            <option value="all"      <?= $activeIn === 'all'      ? 'selected' : '' ?>>All</option>
        </select>
    </div>
    <div class="actions">
...
<?php else: ?>
    <ul class="student-grid" role="list">
        <?php foreach ($students as $s):
            ...
            $sid  = (int)$s['id'];
        ?>
            <li class="student-card <?= $s['is_active'] ? '' : 'is-inactive' ?>"
