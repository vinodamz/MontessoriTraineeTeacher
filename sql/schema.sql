...
CREATE TABLE users (
    ...
    role        ENUM('teacher','admin','non_teaching') NOT NULL DEFAULT 'teacher',
    modules     SET('tasks','montessori','students','crm','recruitment','staff','expenses','fees','logbook','inventory','materials','wacrm','n8n','daycare','plans') NOT NULL DEFAULT '',
