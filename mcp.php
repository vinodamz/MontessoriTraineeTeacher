        ...
        case 'initialize': {
            ...
            return $ok([
                ...
                'instructions'    => "This server reads and writes the school's live database — students, "
                                   ...
                                   . "all_non_teaching, all_staff or users. Frequency daily, weekly, "
                                   . "monthly or adhoc (adhoc needs starts_on; optional ends_on, weekdays, "
                                   . "repeat_as). Then `staff_duty_status` "
