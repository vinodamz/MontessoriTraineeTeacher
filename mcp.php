        ...
        case 'initialize': {
            ...
            return $ok([
                ...
                'instructions'    => "This server reads and writes the school's live database — students, "
                                   ...
                                   . "statement.\n"
                                   . "`insert`, `upsert`, `update` and `delete` write. upsert creates or "
                                   . "updates by primary key (or by where: update if rows match, else insert). "
                                   . "update and delete REQUIRE a where clause and refuse when more rows "
                                   . "match than max_rows, so check the count with `query` before a broad "
                                   . "change. Previous values are recorded, so a mistake can be undone.\n\n"
                                   ...
                                   . "`staff_duty_template_upsert` or the generic `upsert` tool (table "
                                   . "staff_duty_templates, or omit table and pass title/frequency/audience). "
                                   . "Audience all_teachers, all_non_teaching, all_staff or users. Frequency "
                                   . "daily, weekly, monthly or adhoc (adhoc needs starts_on; optional "
                                   . "ends_on, weekdays, repeat_as). Then `staff_duty_status` to see who "
                                   . "ticked.\n\n"
